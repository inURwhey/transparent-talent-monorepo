...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **Tech Debt: Resolve Gemini API Errors**| - | 1000 | 3 | 100% | 0.1 | **3000** | Flash | S | **To Do** |
...
| **UI/UX: Provide explicit error message on resume parse failure** | E02 | 1000 | 2 | 100% | 0.1 | **20000** | Flash | S | **To Do** |
| **UI/UX: Remove auto-redirect from profile save** | E02 | 1000 | 2 | 100% | 0.1 | **20000** | Flash | S | **To Do** |
| **UI/UX: Fix default values for Work Style dropdowns**| E02 | 1000 | 1 | 100% | 0.1 | **10000** | Flash | S | **To Do** |
...
| **Tech Debt: Upgrade Gemini API integration** | Move from the `v1beta` Gemini API endpoint to the stable `v1` endpoint and implement dynamic model discovery and selection. | Low |
