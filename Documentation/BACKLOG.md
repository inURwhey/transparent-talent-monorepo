# Transparent Talent: Product Backlog & Roadmap v1.13
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **Refactor: Modularize Frontend `dashboard/page.tsx`** | 1 | 3 | 100% | 1.0 | **300** | Pro | **To Do** |
| **Refactor: Separate `tracked_jobs.status` into `status` and `status_reason` columns (with ENUMs)** | 1 | 3 | 100% | 0.75 | **4.0** | Flash | **To Do** |

(The rest of the Tier 2, 3, and 4 items remain unchanged)
