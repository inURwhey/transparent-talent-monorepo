...
class ProfileService:
    ...
    # ... (get_profile, get_profile_for_analysis, update_profile methods are unchanged) ...
    ...
    def _format_profile(self, profile_row: DictCursor, description) -> dict:
        ...
        for col in description:
            ...
            # --- THE FIX ---
            # If the value is a Decimal, convert it to a float for correct JSON serialization.
