            ...
            <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-md">
                ...
                {!profile.has_completed_onboarding && (
                    <div className="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 p-4 mb-6 rounded-md" role="alert">
                        ...
                        <p>To find your best-fit opportunities, please submit a resume via the Welcome page and fill out all fields marked with a <span className="text-red-500 font-bold">*</span>.</p>
                    </div>
                )}
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <Collapsible open={openSections.careerGoals} onOpenChange={() => toggleSection('careerGoals')} className="border rounded-md shadow-sm"><CollapsibleTrigger className="flex items-center justify-between w-full p-4 font-semibold text-lg">Career Aspirations{openSections.careerGoals ? <ChevronUp/> : <ChevronDown/>}</CollapsibleTrigger>
                        <CollapsibleContent className="p-4 pt-0 space-y-4">
                            ...
                            <div><Label htmlFor="desired_title">Desired Job Title{isRequired('desired_title') && <span className="text-red-500 ml-1">*</span>}</Label><Input id="desired_title" type="text" value={profile.desired_title || ''} onChange={(e) => handleChange('desired_title', e.target.value)} /></div>
                            <div>
